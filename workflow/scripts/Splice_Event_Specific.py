...
if __name__ == "__main__":
    ...
    Cancer_Data = pd.read_csv(args.info_file, sep="\t")
    Cancer_Data["sample_bed_id"] = Cancer_Data["SampleID"] + "_tumor.bed"
    #print(Cancer_Data)
    ...
    for alt_type in existing_alt_types:
        ...
        alt_type_Filter_TJ = pd.DataFrame({
            ...
            "AS_Total_Number":[len(alt_type_Res_Raw[0]) if len(alt_type_Res_Raw) > 0 else 0],
